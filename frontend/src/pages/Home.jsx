...
//       num: '2',
//       title: 'AI Scan hoga',
//       desc: 'Humara customized institutional-grade Gemini AI scan karega 10 seconds mein.',
//       icon: <Cpu className="h-6 w-6 text-blue-600 animate-pulse" />,
//     },
//     {
//       num: '3',
//       title: 'Result dekho',
//       desc: 'Jaano ki kya woh safe hai, ya suspicious, ya humara SCAM alert active hai.',
...
//       name: 'Ramesh Kumar',
//       city: 'Delhi',
//       quote: 'Mujhe ek WhatsApp pe lottery message aaya tha, maine ScamShield pe double-check kiya toh direct SCAM report aaya! Bach gaya bhai.',
//     },
//     {
//       name: 'Pooja Sharma',
//       city: 'Mumbai',
//       quote: 'Ghar baithe video like karke 5000 kamane ka message aaya tha. Yahan scan kiya toh AI ne pure red flags dikhaye. Truly super smart tracker.',
//     },
//     {
//       name: 'Anil Deshmukh',
//       city: 'Pune',
//       quote: 'Kalyan electricity board ka disconnection warning message aaya tha, is app ne pehli baar mein scan karke fraud target kar diya.',
//     },
//   ];
...
//               Kya yeh <span className="text-blue-600">scam</span> hai?
//             </h1>
//             <p className="text-lg md:text-xl text-gray-500 font-medium max-w-2xl mx-auto">
//               India ka sabse smart scam detector — AI se 10 second mein jaano
//             </p>
//           </div>
...
//           <StatsBar totalScans="2.5M+" scamsFound="450K+" peopleSaved="1.2M+" />
//         </div>
//       </section>
...
//             <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Kaise kaam karta hai?</h2>
//             <p className="text-gray-500 text-sm max-w-md mx-auto">Bharat ka sabse aasan scam scanner. Dus asan kadamon mein report.</p>
//           </div>
...
//           <div className="text-center space-y-2">
//             <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Keval sachhe anubhav</h2>
//             <p className="text-gray-500 text-sm max-w-md mx-auto">Hazaro Bhartiyo ne digital fraud mein fasaney se apne aap ko dur kiya hai.</p>
//           </div>
